...
This repository contains files for the data and models used in "The Impact of Voter ID on Party Vote Share" by Elizabeth Bergman (Department of Political Science, Cal State East Bay) and Philip Yates (Department of Mathematical Sciences, DePaul University).
